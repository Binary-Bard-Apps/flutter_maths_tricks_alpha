            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  getTextWidget("Give Your Opinion", 20, getFontColor(context),fontWeight: FontWeight.w700,textAlign: TextAlign.center),
                  ...
                  getTextWidget("Make better math goal for you,and would love to know how would rate our app?",
                      15, getFontColor(context),fontWeight: FontWeight.w400,textAlign: TextAlign.center),
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(child: getCommonBorderButton(title: "Cancel", function: (){
                        Navigator.pop(context);
                      }, color: getFontColor(context),hSpace: 0,verSpace: 0)),


                      horSpace.horizontalSpace,

                      Expanded(child: getCommonButton(title: "Submit", function: (){
                        Navigator.pop(context);
                        if(rate >= 3) {
                        ...
                        }, color: getPrimaryColor(context),hSpace: 0,verSpace: 0))
