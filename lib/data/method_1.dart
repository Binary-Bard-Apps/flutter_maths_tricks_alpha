...
// Divide by 20
  TrickModel method43() {
    double n1 =
        (getRandomNumber(level * 100, level * 2) / 20).round() * 20.toDouble();
    double n2 = 20;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) +
...
// Divide by 50
  TrickModel method44() {
    double n1 =
        (getRandomNumber(level * 250, level * 2) / 50).round() * 50.toDouble();
    double n2 = 50;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) +
...
// Divide by 25
  TrickModel method45() {
    double n1 =
        (getRandomNumber(level * 250, level * 2) / 25).round() * 25.toDouble();
    double n2 = 25;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) +
...
// Divide by 40
  TrickModel method46() {
    double n1 =
        (getRandomNumber(level * 200, level * 2) / 40).round() * 40.toDouble();
    double n2 = 40;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) +
...
// Divide by 0.5
  TrickModel method47() {
    double n1 =
        (getRandomNumber(level * 2, level * 2) / 0.5).round() * 0.5.toDouble();
    double n2 = 0.5;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) +
...
// Divide by 0.2
  TrickModel method48() {
    double n1 =
        (getRandomNumber(level * 1, level * 2) / 0.2).round() * 0.2.toDouble();
    double n2 = 0.2;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) +
...
// Divide by 0.25
  TrickModel method49() {
    double n1 = (getRandomNumber(level * 1, level * 2) / 0.25).round() *
        0.25.toDouble();
    double n2 = 0.25;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
...
// Divide by 15
  TrickModel method50() {
    double n1 =
        (getRandomNumber(level * 75, level * 2) / 15).round() * 15.toDouble();
    double n2 = 15;
...
// Divide by 6
  TrickModel method51() {
    double n1 =
        (getRandomNumber(level * 30, level * 2) / 6).round() * 6.toDouble();
    double n2 = 6;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) +
  ...
  TrickModel method52() {
    double n1 =
        (getRandomNumber(level * 15, level * 2) / 3).round() * 3.toDouble();
    double n2 = 3;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) +
  ...
  TrickModel method53() {
    double n1 =
        (getRandomNumber(level * 10, level * 2) / 2).round() * 2.toDouble();
    double n2 = 2;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) +
  ...
  TrickModel method54() {
    double n1 =
        (getRandomNumber(level * 36, level * 2) / 7).round() * 7.toDouble();
    double n2 = 8;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) +
  ...
  TrickModel method55() {
    double n1 =
        (getRandomNumber(level * 45, level * 2) / 9).round() * 9.toDouble();
    double n2 = 7;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) +
  ...
  TrickModel method56() {
    double n1 =
        (getRandomNumber(level * 55, level * 2) / 11).round() * 11.toDouble();
    double n2 = 9;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) +
  ...
  // Square on numbers ending in 5
  TrickModel method57() {
    n1 = getRandomNumber(level * 1, 2);
